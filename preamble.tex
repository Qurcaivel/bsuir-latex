...
\captionsetup[figure]{labelformat=stbfigure, justification=centering, labelsep=stb, size=small}
...
\usepackage{url} % во избежание проблем с использованием электронных ресурсов в источниках, содержащих нижнее подчеркивание в ссылке
\urlstyle{same} % стиль совпадает с системным