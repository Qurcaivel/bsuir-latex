...
\linespread{1.15} % Reccomended: 1.00, 1.15, 1.25

\newlength{\parinlen}
\setlength{\parinlen}{12.5mm} % Reccomended: 1.25cm, 1.27cm
...
\newlength{\eqindent}
\setlength{\eqindent}{\baselineskip} % Reccomended: baselineskip, 1.3em, 1.4em, 1.5em
...
\bibliographystyle{bsuir-latex/styles/belarus-specific-utf8gost780u}
